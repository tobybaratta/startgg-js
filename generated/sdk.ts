...
export type EventStandingsQuery = { __typename?: 'Query', event?: { __typename?: 'Event', id?: string | null, name?: string | null, standings?: { __typename?: 'StandingConnection', nodes?: Array<{ __typename?: 'Standing', placement?: number | null, entrant?: { __typename?: 'Entrant', id?: string | null, name?: string | null } | null } | null> | null } | null } | null };

export type GetTournamentByNameQueryVariables = Exact<{
  name: Scalars['String']['input'];
}>;


export type GetTournamentByNameQuery = { __typename?: 'Query', tournaments?: { __typename?: 'TournamentConnection', nodes?: Array<{ __typename?: 'Tournament', name?: string | null } | null> | null } | null };

export type LeagueScheduleQueryVariables = Exact<{
  slug: Scalars['String']['input'];
}>;


export type LeagueScheduleQuery = { __typename?: 'Query', league?: { __typename?: 'League', id?: string | null, name?: string | null, events?: { __typename?: 'EventConnection', pageInfo?: { __typename?: 'PageInfo', totalPages?: number | null, total?: number | null } | null, nodes?: Array<{ __typename?: 'Event', id?: string | null, name?: string | null, startAt?: number | null, tournament?: { __typename?: 'Tournament', id?: string | null, name?: string | null } | null } | null> | null } | null } | null };

export type StreamQueueOnTournamentQueryVariables = Exact<{
  tourneySlug: Scalars['String']['input'];
}>;


export type StreamQueueOnTournamentQuery = { __typename?: 'Query', tournament?: { __typename?: 'Tournament', id?: string | null, streamQueue?: Array<{ __typename?: 'StreamQueue', stream?: { __typename?: 'Streams', streamSource?: StreamSource | null, streamName?: string | null } | null, sets?: Array<{ __typename?: 'Set', id?: string | null } | null> | null } | null> | null } | null };


export const EventStandingsDocument = gql`
  ...
  event(id: $eventId) {
    ...
    `;
export const GetTournamentByNameDocument = gql`
    query GetTournamentByName($name: String!) {
  tournaments(query: {page: 1, filter: {name: $name}}) {
    nodes {
      name
    }
  }
    ...
    `;
export const LeagueScheduleDocument = gql`
  ...
  league(slug: $slug) {
    ...
    `;
export const StreamQueueOnTournamentDocument = gql`
...
const EventStandingsDocumentString = print(EventStandingsDocument);
const GetTournamentByNameDocumentString = print(GetTournamentByNameDocument);
const LeagueScheduleDocumentString = print(LeagueScheduleDocument);
const StreamQueueOnTournamentDocumentString = print(StreamQueueOnTournamentDocument);
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    EventStandings(variables: EventStandingsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data: EventStandingsQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<EventStandingsQuery>(EventStandingsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'EventStandings', 'query');
    },
    GetTournamentByName(variables: GetTournamentByNameQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data: GetTournamentByNameQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetTournamentByNameQuery>(GetTournamentByNameDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetTournamentByName', 'query');
    },
    LeagueSchedule(variables: LeagueScheduleQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data: LeagueScheduleQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<LeagueScheduleQuery>(LeagueScheduleDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'LeagueSchedule', 'query');
    },
    StreamQueueOnTournament(variables: StreamQueueOnTournamentQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data: StreamQueueOnTournamentQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<StreamQueueOnTournamentQuery>(StreamQueueOnTournamentDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'StreamQueueOnTournament', 'query');
    }
  };
}
